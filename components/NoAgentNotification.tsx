...
export function NoAgentNotification(props: NoAgentNotificationProps) {
  ...
  return (
    <>
      {showNotification ? (
        <div className="fixed text-sm left-1/2 max-w-[90vw] -translate-x-1/2 flex top-6 items-center gap-4 bg-white px-4 py-3 rounded-lg shadow-md">
          <div>
            {/* Warning Icon */}
            <svg
              width="24"
          ...
          <p className="text-pretty w-max text-blue-800">
          ...
          <a
            ...
            target="_blank"
            className="underline whitespace-nowrap text-blue-600 hover:text-blue-800"
          >
            View guide
          </a>
